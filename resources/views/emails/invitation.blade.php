                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <div style="color:#000000;font-size:14px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;">
                                                                                            <p style="margin: 0; margin-bottom: 16px;">Vous avez reçu une nouvelle invitation !</p>
                                                                                            <p style="margin: 0; margin-bottom: 16px;"><strong>Communauté:</strong> {{ $community }}</p>
                                                                                            <p style="margin: 0; margin-bottom: 16px;">Vous êtes libre d'accepter ou non l'invitation depuis votre espace personnel.</p>
                                                                                            <p style="margin: 0;"> </p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
